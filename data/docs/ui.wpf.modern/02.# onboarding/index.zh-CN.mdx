...
搜索时会出现一些其他库。您可以在我们的 [Github 个人资料](https://github.com/iNKORE-NET) 和它们的存储库中了解更多关于它们的信息。

:::

:::warning 为什么选择 **iNKORE.UI.WPF**？
...
// highlight-end
    ...
    <ui:SimpleStackPanel VerticalAlignment="Center" Spacing="5">
        ...
        <TextBlock Text="但是嘿，我们值得 :-)" FontSize="20" TextAlignment="Center"/>
