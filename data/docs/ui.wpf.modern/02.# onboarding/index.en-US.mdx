...
Then click **Browse**, and type `inkore` in the search box. All our public libraries will appear here. Select **iNKORE.UI.WPF.Modern** and click **Install**.
