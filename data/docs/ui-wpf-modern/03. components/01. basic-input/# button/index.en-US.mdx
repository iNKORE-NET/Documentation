...
![A basic button](a-basic-button.png)
...
![Button with icon only](button-with-icon-only.png)

For more information about *ui:FontIcon*, please [click here](%BASE_NAME%/components/media/font-icon)
...
![A button with icon and Text](a-button-with-icon-and-text.png)

For more information about IconAndText, please [click here](%BASE_NAME%/components/media/icon-and-text)
